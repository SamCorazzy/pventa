        ...
        <div>
            <table class="content-table" border="1" cellspacing="1" bordercolor="black" style="border-collapse:collapse; border-color: black; margin: 0 auto">
                ...
                <tbody>
                    ...
                    <?php
                    include('generar_ventas.php');
                    $a = 0;
                    foreach ($datosC as $I) { //se hace un ciclo foreach para poder leer los datos
                    ?>
                        <tr>
                            <th><?php echo $I['num_venta']; //datos php obtenidos ?></th>
                            <th><?php echo $I['fecha']; ?></th>
                            <th><?php echo $I['codigo_productos']; ?></th>
                            <th><?php echo $I['nombre_productos']; ?></th>
                            <th><?php echo $I['numero_productos'];?></th>
                            <th><?php echo $I['total']; ?></th>
                            <th><?php echo $I['usuario']; ?></th>
                        </tr>
                    <?php }
                    ?>
                </tbody>
