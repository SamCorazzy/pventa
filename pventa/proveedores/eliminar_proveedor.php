...
<body>
    ...
    // Proceso de PHP para eliminar registros de la tabla proveedores
    $url = $_GET["url"];
    $eliminardatos = "DELETE FROM proveedores WHERE num_proveedor = '$url'";
    ...
    if ($resultado) {
        ...
        swal.fire({
            title: "Error!",
            text: "No se eliminó el proveedor",
            icon: "error",
            showConfirmButton: false,
            timer: 2600
          });
