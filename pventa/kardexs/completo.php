...
<body>
    ...
    <div class="m-3 md:m-6 px-4 py-3 bg-white shadow-xl rounded-xl flex justify-between items-stretch">
        ...
        <div class="self-center font-medium md:text-xl">
            <h2>Kardex - Completo</h2>
        </div>
        <a href="pdf_com.php" target="_blank" title="Imprimir" class="bg-orange-200 hover:bg-orange-100 p-2 rounded-xl self-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
