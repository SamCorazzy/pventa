...
$registros_total = "SELECT COUNT(*)  AS Total FROM movimientos LEFT JOIN inventario ON movimientos.codigo_prod = inventario.codigo_prod WHERE DATE(movimientos.fecha_mov) = CURDATE() ORDER BY movimientos.fecha_mov DESC;";//el valor despues de AS da el nombre dal resultado obtenido
