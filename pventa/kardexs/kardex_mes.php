...
$registros_total = "SELECT COUNT(*)  AS Total FROM movimientos LEFT JOIN inventario ON movimientos.codigo_prod = inventario.codigo_prod WHERE MONTH(movimientos.fecha_mov) = MONTH(CURRENT_DATE()) ORDER BY movimientos.fecha_mov DESC;";//el valor despues de AS da el nombre dal resultado obtenido
